...
STYLES = [
  {
    ...
    stylers: [
      {hue: "#ff00ee"},{weight: 0.1},{visibility: "on"},{color: "#cccccc"}
    ]
  },{
    ...
    elementType: "geometry"
    stylers: [
      {hue: "#ff005d"},{saturation: -3},{color: "#000000"},{weight: 0.4}
    ]
  },{
    featureType: "road"
    elementType: "labels.text"
    ...
    elementType: "geometry"
    stylers: [
      {hue: "#0000ff"},{color: "#9a8080"}
    ]
  },{
    featureType: "poi.business"
    elementType: "geometry"
    stylers: [
      {hue: "#ff0077"},{color: "#918080"}
    ]
  },{
    featureType: "road.highway"
    elementType: "labels.icon"
    stylers: [
      {lightness: 2},{gamma: 0.96},{hue: "#ffe500"}
    ]
  },{
